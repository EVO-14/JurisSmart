        ...
        try {
            ...
            if (id.equals("")) {
                ...
                if (fotoPerfil.equals("user.webp")) {
                    st.executeUpdate("UPDATE usuario SET nome = '" + nome + "', email = '" + email + "', fone = '" + fone + "', cpf = '" + cpf + "', dataNasc = '" + dataNasc + "', funcao = '" + funcao + "', senha = '" + senha + "', permissao = '" + permissao + "', departamento = '" + departamento + "', dataAdmissao = '" + dataAdmissao + "', status = '" + status + "', observacoes = '" + observacoes + "', dataCadastro = '" + dataCadastro + "' WHERE id = '" + id + "'");
                } else {
