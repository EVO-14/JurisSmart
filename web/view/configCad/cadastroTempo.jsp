...
<html>
    <head>
        ...
        <style>
            ...
            .modalCadastrarTempo .modal-body {
                max-height: calc(80vh - 120px);
                overflow-y: auto;
            }

            .modalCadastrarTempo .input-file {
                text-align: center;
            }

            .modalCadastrarTempo .input-file img {
                max-height: 150px;
            }

            .modalCadastrarTempo .modal-body input::placeholder {
                color: rgba(0, 0, 0, 0.3);
            }

            .modalCadastrarTempo .image-label {
    ...
    <body>
            ...
            <div class="search">
                <div class="search-left">
                    <form method="post" id="search" class="search">
                        <button type="submit" id="btn-buscar" name="btn-buscar" title="[Consultar Tempo]">
        ...
        <div class="modal fade modalCadastrarTempo" id="cadastrarTempoModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <%
                            ...
                            if (request.getParameter("id") != null) {
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("SELECT * FROM tempo WHERE id = '" + id + "'");
                                    while (rs.next()) {
        ...
        <%
            if (request.getParameter("funcao") != null && request.getParameter("funcao").equals("novo")) {
                out.println("<script>$(document).ready(function () {$('#cadastrarTempoModal').modal('show');});</script>");
            }
        %>
        <!-- FUNÇÃO PARA MODAL INSERIR -->
                        ...
                        success: function (mensagem) {
                            if (mensagem.trim() === 'Excluido') {
                                function showPopup(message) {
                                    ...
                                    // Remover o tempo funcao da URL sem recarregar a página
