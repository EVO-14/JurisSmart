...
<html>
    <head>
        ...
        <title>| JurisSmart - Parâmetro |</title>
        <style>
            main img {
                width: 50px;
            }
            ...
            .modalCadastrarParametro {
                margin-top: 80px;
            }

            .modalCadastrarParametro .modal-body {
                max-height: calc(80vh - 120px);
                overflow-y: auto;
            }

            .modalCadastrarParametro .input-file {
                text-align: center;
            }

            .modalCadastrarParametro .input-file img {
                max-height: 150px;
            }

            .modalCadastrarParametro .modal-body input::placeholder {
                color: rgba(0, 0, 0, 0.3);
            }

            .modalCadastrarParametro .image-label {
    ...
    <body>
            ...
            <div class="search">
                <div class="search-left">
                    <form method="post" id="search" class="search">
                        <button type="submit" id="btn-buscar" name="btn-buscar" title="[Consultar Parâmetro]">
        ...
        <div class="modal fade modalCadastrarParametro" id="cadastrarParametroModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <%
                            ...
                            if (request.getParameter("id") != null) {
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("SELECT * FROM parametro WHERE id = '" + id + "'");
                                    while (rs.next()) {
        ...
        <%
            if (request.getParameter("funcao") != null && request.getParameter("funcao").equals("novo")) {
                out.println("<script>$(document).ready(function () {$('#cadastrarParametroModal').modal('show');});</script>");
            }
        %>
        <!-- FUNÇÃO PARA MODAL INSERIR -->
