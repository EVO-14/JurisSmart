...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="icon" href="<%= request.getContextPath()%>/imagens/icons/template/head-gear-svgrepo-com.svg">
        ...
        <header>
            ...
            <div class="right">
                <a href="#" class="icons-header">
                    <img src="<%= request.getContextPath()%>/imagens/icons/template/chat.svg" alt="[]">
                </a>
                <a href="#" class="icons-header">
                    <img src="<%= request.getContextPath()%>/imagens/icons/template/question.svg" alt="[]">
                </a>
                <a href="#" class="icons-header">
                    <img src="<%= request.getContextPath()%>/imagens/icons/template/notification.svg" alt="[]">
                </a>
                <div class="dropdown">
